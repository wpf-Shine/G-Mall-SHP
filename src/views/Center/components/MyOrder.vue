    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item"
               v-for="order,index in myOrderList.records"
               :key="order.id">
          <thead>
            <tr>
              <th colspan="5">
            ...
            <tr v-for="(orderDetail,index) in order.orderDetailList"
              ...
              <td width="60%">
                <div class="typographic">
                  ...
                  <a href="#"
                     class="block-text">{{orderDetail.skuName}}</a>
...
export default {
  ...
  computed: {
    ...
    total () {
      return this.myOrderList.total
    }
  },
  methods: {
    getMyOrderList () {
      this.$store.dispatch('getMyOrderList', { page: this.page, limit: this.limit }).then(() => { }).catch(err => err)
    },
    getPageNo (data) {
      this.page = data
      this.getMyOrderList()
